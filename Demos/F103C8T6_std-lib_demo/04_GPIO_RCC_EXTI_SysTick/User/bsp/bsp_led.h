...
#define LED_ON()        GPIO_Register_ResetBits(LED_GPIO_PORT,LED_GPIO_PIN)
#define LED_OFF()       GPIO_Register_SetBits(LED_GPIO_PORT,LED_GPIO_PIN)
#define LED_TOGGLE()    GPIO_Register_ToggleBits(LED_GPIO_PORT,LED_GPIO_PIN)
