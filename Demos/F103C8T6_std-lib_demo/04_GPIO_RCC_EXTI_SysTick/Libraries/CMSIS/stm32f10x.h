...
/* 在Keil选项卡设置C/C++中添加处理宏: STM32F10X_MD,USE_STDPERIPH_DRIVER */
/* 或在VSCode的参数中添加处理宏: Ctrl+Shift+P选择C/C++: Edit configurations生成c_cpp_properties.json文件*/
/* 在"defines"项添加: ,"STM32F10X_MD","USE_STDPERIPH_DRIVER" */
